...
const Workspace = () => {
  return (
    <section
      className="py-20 bg-gradient-to-r from-blue-700 to-blue-500 text-white"
      style={{
        backgroundImage: "url('/workSpaceBg.jpg')",
    ...
    >
      <div className="container mx-auto px-6 text-center">
        ...
        <div className="grid md:grid-cols-4 gap-8 mt-12">
          {/* Professional */}
          <div className="group relative flex flex-col items-center text-center px-6 py-10 transition duration-300 border h-96 border-white/20">
          ...
          <div className="group relative flex flex-col items-center text-center px-6 py-8 transition duration-300 border h-96 border-white/20">
            <Image src="/2.jpg" alt="Project Manager" width={48} height={48} className="mt-6" />
            <hr className="w-12 border-t-2 border-white my-4" />
          ...
          <div className="group relative flex flex-col items-center text-center px-6 py-8 transition duration-300 border h-96 border-white/20">
            <Image src="/3.jpg" alt="Marketing Professional" width={48} height={48} className="mt-6" />
            <hr className="w-12 border-t-2 border-white my-4" />
          ...
          {/* Freelancer */}
          <div className="group relative flex flex-col items-center text-center px-6 py-8 transition duration-300 border h-96 border-white/20">
            <Image src="/2.jpg" alt="Freelancer" width={48} height={48} className="mt-6" />
            <hr className="w-12 border-t-2 border-white my-4" />
